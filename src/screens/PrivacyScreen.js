    ...
    return (
        <div className="terms">
            ...
            <div className="terms__container">
                <div>
                    <h1>
                        <strong>Privacy Policy for PCA Client Portal</strong>
                    </h1>
                    <p>
                        <span>
                            At PCA Client Portal, accessible from
                            https://example.com, one of our main priorities is the
                            privacy of our visitors. This Privacy Policy document contains types of
                            information that is collected and recorded by PCA Client Portal and
                            how we use it.
                        </span>
                    </p>
                    <p>
                    ...
                    <p>
                        <span>
                            ...
                            shared and/or collect in PCA Client Portal. This policy is not
                    ...
                    <p>
                        <span>
                            PCA Client Portal follows a standard procedure of using log files.
                    ...
                    <p>
                        <span>
                            Like any other website, PCA Client Portal uses 'cookies'. These
                    ...
                    <p>
                        <span>
                            ...
                            advertising partners of PCA Client Portal.
                        </span>
                    </p>
                    <p>
                        <span>
                            ...
                            advertisements and links that appear on PCA Client Portal, which are
                    ...
                    <p>
                        <span>
                            Note that PCA Client Portal has no access to or control over these
                    ...
                    <p>
                        <span>
                            PCA Client Portal's Privacy Policy does not apply to other
                    ...
                    <p>
                        <span>
                            PCA Client Portal does not knowingly collect any Personal

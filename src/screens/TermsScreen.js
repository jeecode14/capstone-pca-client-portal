...
export default function TermsScreen() {
    ...
    return (
        <div className="terms">
            ...
            <div className="terms__hero">Terms and Condition</div>
            <div className="terms__container">
                <p>
                    <strong>Terms and Conditions</strong>
                </p>

                <p>Welcome to PCA Client Portal!</p>

                <p>
                    These terms and conditions outline the rules and regulations for the use of
                    PCA Client Portal's Website, located at https://example.com/.
                </p>

                <p>
                    By accessing this website we assume you accept these terms and conditions. Do
                    not continue to use PCA Client Portal if you do not agree to take all of the
                ...
                <p>
                    ...
                    Company&rsquo;s terms and conditions. "The Company", "Ourselves", "We", "Our"
                    and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the
                    ...
                    Client&rsquo;s needs in respect of provision of the Company&rsquo;s stated
                    services, in accordance with and subject to, prevailing law of Netherlands. Any
                ...
                <p>
                    We employ the use of cookies. By accessing PCA Client Portal, you agreed to
                    use cookies in agreement with the PCA Client Portal's Privacy Policy.
                </p>
                ...
                <p>
                    Unless otherwise stated, PCA Client Portal and/or its licensors own the
                    intellectual property rights for all material on PCA Client Portal. All
                    intellectual property rights are reserved. You may access this from PCA Client Portal for your own personal use subjected to restrictions set in these
                ...
                <ul>
                    <li>Republish material from PCA Client Portal</li>
                    <li>Sell, rent or sub-license material from PCA Client Portal</li>
                    <li>Reproduce, duplicate or copy material from PCA Client Portal</li>
                    <li>Redistribute content from PCA Client Portal</li>
                </ul>

                <p>
                    This Agreement shall begin on the date hereof. Our Terms and Conditions were
                    created with the help of the PromoterKit's Terms And Conditions Generator.
                </p>

                <p>
                    Parts of this website offer an opportunity for users to post and exchange
                    opinions and information in certain areas of the website. PCA Client Portal
                    does not filter, edit, publish or review Comments prior to their presence on the
                    website. Comments do not reflect the views and opinions of PCA Client Portal,its agents and/or affiliates. Comments reflect the views and opinions of
                    the person who post their views and opinions. To the extent permitted by
                    applicable laws, PCA Client Portal shall not be liable for the Comments or
                    for any liability, damages or expenses caused and/or suffered as a result of any
                    use of and/or posting of and/or appearance of the Comments on this website.
                </p>

                <p>
                    PCA Client Portal reserves the right to monitor all Comments and to remove
                ...
                <p>
                    You hereby grant PCA Client Portal a non-exclusive license to use, reproduce,
                ...
                <p>
                    ...
                    of PCA Client Portal; and (d) the link is in the context of general resource
                    information.
                </p>
                ...
                <p>
                    ...
                    the context of the linking party&rsquo;s site.
                </p>

                <p>
                    If you are one of the organizations listed in paragraph 2 above and are
                    interested in linking to our website, you must inform us by sending an e-mail to
                    PCA Client Portal. Please include your name, your organization name, contact
                ...
                <ul>
                    ...
                    <li>
                        ...
                        sense within the context and format of content on the linking party&rsquo;s
                        site.
                    </li>
                </ul>

                <p>
                    No use of PCA Client Portal's logo or other artwork will be allowed for
                ...
                <p>
                    ...
                    request. We also reserve the right to amen these terms and conditions and
                    it&rsquo;s linking policy at any time. By continuously linking to our Website,
